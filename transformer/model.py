...
def build_transformer(
    ...
    print(f"Number of parameters in the transformer: {num_params}")

    # Print the shape and size of each parameter in the transformer
    for name, p in transformer.named_parameters():
        print(f"{name}: {p.shape}, {p.numel()} parameters")
    return transformer
